...
public interface OpenSCADTypes {
  ...
  IElementType ABS_EXPR = OpenSCADElementFactory.getElementType("ABS_EXPR");
  IElementType ACOS_EXPR = OpenSCADElementFactory.getElementType("ACOS_EXPR");
  ...
  IElementType ASIN_EXPR = OpenSCADElementFactory.getElementType("ASIN_EXPR");
  IElementType ASSERT_OBJ = OpenSCADElementFactory.getElementType("ASSERT_OBJ");
  IElementType ASSIGNMENT = OpenSCADElementFactory.getElementType("ASSIGNMENT");
  IElementType ASSIGN_OP = OpenSCADElementFactory.getElementType("ASSIGN_OP");
  IElementType ATAN_2_EXPR = OpenSCADElementFactory.getElementType("ATAN_2_EXPR");
  IElementType ATAN_EXPR = OpenSCADElementFactory.getElementType("ATAN_EXPR");
  ...
  IElementType CHR_EXPR = OpenSCADElementFactory.getElementType("CHR_EXPR");
  IElementType CIRCLE_OBJ = OpenSCADElementFactory.getElementType("CIRCLE_OBJ");
  IElementType COLOR_OP = OpenSCADElementFactory.getElementType("COLOR_OP");
  IElementType CONCAT_EXPR = OpenSCADElementFactory.getElementType("CONCAT_EXPR");
  IElementType CONDITIONAL_EXPR = OpenSCADElementFactory.getElementType("CONDITIONAL_EXPR");
  IElementType COS_EXPR = OpenSCADElementFactory.getElementType("COS_EXPR");
  IElementType CROSS_EXPR = OpenSCADElementFactory.getElementType("CROSS_EXPR");
  IElementType CUBE_OBJ = OpenSCADElementFactory.getElementType("CUBE_OBJ");
  IElementType CYLINDER_OBJ = OpenSCADElementFactory.getElementType("CYLINDER_OBJ");
  IElementType DEBUG_OP = OpenSCADElementFactory.getElementType("DEBUG_OP");
  IElementType DIFFERENCE_OP = OpenSCADElementFactory.getElementType("DIFFERENCE_OP");
  ...
  IElementType ELLIPSE_OBJ = OpenSCADElementFactory.getElementType("ELLIPSE_OBJ");
  ...
  IElementType EXP_EXPR = OpenSCADElementFactory.getElementType("EXP_EXPR");
  IElementType FLOOR_EXPR = OpenSCADElementFactory.getElementType("FLOOR_EXPR");
  ...
  IElementType IMPORT_DXF_OBJ = OpenSCADElementFactory.getElementType("IMPORT_DXF_OBJ");
  IElementType IMPORT_OBJ = OpenSCADElementFactory.getElementType("IMPORT_OBJ");
  IElementType IMPORT_STL_OBJ = OpenSCADElementFactory.getElementType("IMPORT_STL_OBJ");
  ...
  IElementType INTERSECTION_FOR_OP = OpenSCADElementFactory.getElementType("INTERSECTION_FOR_OP");
  IElementType INTERSECTION_OP = OpenSCADElementFactory.getElementType("INTERSECTION_OP");
  IElementType LEN_EXPR = OpenSCADElementFactory.getElementType("LEN_EXPR");
  IElementType LET_ELEMENT = OpenSCADElementFactory.getElementType("LET_ELEMENT");
  IElementType LET_EXPR = OpenSCADElementFactory.getElementType("LET_EXPR");
  IElementType LET_OP = OpenSCADElementFactory.getElementType("LET_OP");
  IElementType LINEAR_EXTRUDE_OP = OpenSCADElementFactory.getElementType("LINEAR_EXTRUDE_OP");
  ...
  IElementType LN_EXPR = OpenSCADElementFactory.getElementType("LN_EXPR");
  IElementType LOG_EXPR = OpenSCADElementFactory.getElementType("LOG_EXPR");
  IElementType LOOKUP_EXPR = OpenSCADElementFactory.getElementType("LOOKUP_EXPR");
  IElementType MAX_EXPR = OpenSCADElementFactory.getElementType("MAX_EXPR");
  IElementType MINKOWSKI_OP = OpenSCADElementFactory.getElementType("MINKOWSKI_OP");
  IElementType MINUS_EXPR = OpenSCADElementFactory.getElementType("MINUS_EXPR");
  IElementType MIN_EXPR = OpenSCADElementFactory.getElementType("MIN_EXPR");
  IElementType MIRROR_OP = OpenSCADElementFactory.getElementType("MIRROR_OP");
  ...
  IElementType NORM_EXPR = OpenSCADElementFactory.getElementType("NORM_EXPR");
  IElementType OBJECT = OpenSCADElementFactory.getElementType("OBJECT");
  IElementType OFFSET_OP = OpenSCADElementFactory.getElementType("OFFSET_OP");
  ...
  IElementType PARENT_MODULE_EXPR = OpenSCADElementFactory.getElementType("PARENT_MODULE_EXPR");
  ...
  IElementType POLYGON_OBJ = OpenSCADElementFactory.getElementType("POLYGON_OBJ");
  ...
  IElementType ROTATE_EXTRUDE_OP = OpenSCADElementFactory.getElementType("ROTATE_EXTRUDE_OP");
  IElementType ROTATE_OP = OpenSCADElementFactory.getElementType("ROTATE_OP");
  IElementType ROUND_EXPR = OpenSCADElementFactory.getElementType("ROUND_EXPR");
  IElementType SCALE_OP = OpenSCADElementFactory.getElementType("SCALE_OP");
  IElementType SEARCH_EXPR = OpenSCADElementFactory.getElementType("SEARCH_EXPR");
  IElementType SELECT_EXPR = OpenSCADElementFactory.getElementType("SELECT_EXPR");
  IElementType SIGN_EXPR = OpenSCADElementFactory.getElementType("SIGN_EXPR");
  IElementType SIN_EXPR = OpenSCADElementFactory.getElementType("SIN_EXPR");
  IElementType SPHERE_OBJ = OpenSCADElementFactory.getElementType("SPHERE_OBJ");
  IElementType SQRT_EXPR = OpenSCADElementFactory.getElementType("SQRT_EXPR");
  IElementType SQUARE_OBJ = OpenSCADElementFactory.getElementType("SQUARE_OBJ");
  IElementType STR_EXPR = OpenSCADElementFactory.getElementType("STR_EXPR");
  IElementType SURFACE_OBJ = OpenSCADElementFactory.getElementType("SURFACE_OBJ");
  IElementType TAN_EXPR = OpenSCADElementFactory.getElementType("TAN_EXPR");
  IElementType TEXT_OBJ = OpenSCADElementFactory.getElementType("TEXT_OBJ");
  IElementType TRANSLATE_OP = OpenSCADElementFactory.getElementType("TRANSLATE_OP");
